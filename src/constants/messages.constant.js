  ...
  RESUMES: {
    COMMON: {
      ...
      CONTENT: {
        ...
        MIN_LENGTH: `자기소개는 ${MIN_RESUME_LENGTH}자 이상 작성하셔야 합니다.`,
      },
      NOT_FOUND: "이력서가 존재하지 않습니다.",
    },
    CREATED: {
      SUCCEED: "이력서 생성이 완료되었습니다.",
    },
    READ_LIST: {
      SUCCEED: "이력서 목록조회에 성공했습니다.",
      LOG: { SUCCEED: "이력서 로그 목록조회에 성공했습니다." },
    },
    READ_DETAIL: {
